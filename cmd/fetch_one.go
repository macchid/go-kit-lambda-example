...
func main() {
	...
	lambda.StartHandlerWithContext(ctx, awslambda.NewHandler(
		transport.MakeLoggerMiddleware(&logger, "Endpoints::FetchOne")(transport.MakeFetchOneEndpoint(svc)),
